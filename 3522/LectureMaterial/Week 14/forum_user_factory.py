...
class Forum:
    ...
    def add_user(self, factory : UserFactory):
        """
        ...
        to create the user
        """
        user = factory.create_user() #DEPENDENCY INJECTION: UserFactory 'injects' the ForumWebsite with the right kind of user
...
def get_user_factory() -> UserFactory:
    ...
    factory_class = MemberUserFactory if choice == 1 else GuestUserFactory
...
def main():
    ...
    # DEPENDENCY INJECTION: get_user_factory() 'injects' the correct factory into my_forum.add_user()
